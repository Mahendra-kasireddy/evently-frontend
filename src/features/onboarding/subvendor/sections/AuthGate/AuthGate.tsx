...
/**
 * Inline OTP gate for sub-vendor onboarding — same pattern as the organizer
 * onboarding AuthGate, so an unauthenticated visitor can verify their mobile
 * in place and continue instead of being bounced to /login.
 */
  ...
  return (
    <div className={styles.card}>
      ...
      <p className={styles.sub}>
        Sub-vendor onboarding uses the same secure login. Verify your number to start.
      </p>
